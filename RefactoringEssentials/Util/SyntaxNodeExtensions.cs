...
namespace RefactoringEssentials
{
	...
	static partial class SyntaxNodeExtensions
    {
        ...
        private static SyntaxTrivia ConvertTrivia(SyntaxTrivia t)
        {
            ...
            return convertedKind.HasValue ? SyntaxFactory.Comment($"/* TODO ERROR: Skipped {convertedKind.Value.Key}") : default(SyntaxTrivia);
        }
